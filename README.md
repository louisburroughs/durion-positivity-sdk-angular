...
| Angular version target | Peer dep only                          | `ngVersion: 22`                                |
...
- [durion-positivity-sdk-angular](#durion-positivity-sdk-angular)
  ...
  - [Installation](#installation-1)
    - [In a monorepo (workspaces)](#in-a-monorepo-workspaces-1)
    - [In a consumer application (local path)](#in-a-consumer-application-local-path-1)
    - [From npm (when published)](#from-npm-when-published-1)
    - [Requirements](#requirements-1)
  - [Quick Start](#quick-start-1)
  - [Configuration Reference](#configuration-reference-1)
    - [Headers injected on every request](#headers-injected-on-every-request-1)
    - [Token management](#token-management-1)
  - [Domain Clients](#domain-clients-1)
    - [Security (`@durion-sdk/security`)](#security-durion-sdksecurity-1)
    - [Order (`@durion-sdk/order`)](#order-durion-sdkorder-1)
    - [Accounting (`@durion-sdk/accounting`)](#accounting-durion-sdkaccounting-1)
  - [Workflow Helpers](#workflow-helpers-1)
    - [`SecurityAuthWorkflow`](#securityauthworkflow-1)
    - [`OrderPriceOverrideWorkflow`](#orderpriceoverrideworkflow-1)
    - [`WorkorderEstimateWorkflow`](#workorderestimateworkflow-1)
  - [Error Handling](#error-handling-1)
    - [`DurionApiError` shape](#durionapierror-shape-1)
  - [Generated Code](#generated-code-1)
    - [Regenerating clients](#regenerating-clients-1)
    - [What is generated vs. hand-written](#what-is-generated-vs-hand-written-1)
  - [Build \& Outputs](#build--outputs-1)
  - [Testing](#testing-1)
  - [Scripts Reference](#scripts-reference-1)
...
- **TypeScript 6.0+** for consumers using type declarations
...
Client services and model interfaces are generated by **OpenAPI Generator v7.5.0** (`typescript-angular` generator, `ngVersion: 22`) from the backend service OpenAPI specs.
...
- **Node ^22.22.3 or ^24.15.0** (Fetch API built-in)
- **TypeScript 6.0+** for consumers using type declarations
