...
| Script                            | Description                                                  |
| --------------------------------- | ------------------------------------------------------------ |
| `./scripts/generate_angular.sh`   | Angular `typescript-angular` generation (primary)            |
| `./scripts/generate.sh`           | Legacy fetch-based generation (use `generate_angular.sh` instead) |
| `./scripts/generate-openapi.sh`   | Fetch raw OpenAPI specs from running backend services        |
...
├── scripts/
│   ├── generate_angular.sh       # Angular OpenAPI generation pipeline (primary)
│   ├── generate.sh               # Legacy fetch-based generation
│   ├── generate-openapi.sh       # Fetch raw specs from running backend
...
3. **Use `generate_angular.sh`** — this repo targets `typescript-angular`; do not use `generate.sh` to regenerate packages.
