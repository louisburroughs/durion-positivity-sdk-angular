...
export function instanceOfPurchaseOrderResponse(value: object): value is PurchaseOrderResponse {
    ...
    const optionalStringProperties = createPurchaseOrderResponseOptionalProperties({ name: 'purchaseOrderId', nullable: false }, { name: 'vendorId', nullable: false }, { name: 'poNumber', nullable: false }, { name: 'status', nullable: false }, { name: 'currency', nullable: false }, { name: 'shipToLocationId', nullable: false }, { name: 'paymentTermsId', nullable: false }, { name: 'poDate', nullable: false }, { name: 'expectedDeliveryDate', nullable: false }, { name: 'requestedBy', nullable: false }, { name: 'comment', nullable: false }, { name: 'approverId', nullable: false }, { name: 'approvalTimestamp', nullable: false }, { name: 'approvalNotes', nullable: false }, { name: 'encumbranceRef', nullable: false }, { name: 'createdBy', nullable: false }, { name: 'updatedBy', nullable: false }, { name: 'createdAt', nullable: false }, { name: 'updatedAt', nullable: false }, );
