...
export class CreditMemosService {
    ...
    public createCreditMemo(createCreditMemoRequest: CreateCreditMemoRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<CreditMemoResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public getCreditMemo(creditMemoId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<CreditMemoResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public listCreditMemos(pageable: Pageable, customerId?: string, originalInvoiceId?: string, status?: 'DRAFT' | 'POSTED' | 'APPLIED' | 'VOIDED', observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (originalInvoiceId !== undefined && originalInvoiceId !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>originalInvoiceId, 'originalInvoiceId');
        }
        ...
        let localVarPath = `/v1/accounting/credit-memos`;
        return this.httpClient.request<PageCreditMemoResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
