...
function isOptionalPageVendorBillListRowPropertyOfType(
...
type PageVendorBillListRowOptionalProperty = Readonly<{
    name: string;
    nullable: boolean;
}>;

function createPageVendorBillListRowPropertyNames(...propertyNames: string[]): ReadonlyArray<string> {
    return propertyNames;
}

function createPageVendorBillListRowOptionalProperties(
    ...properties: PageVendorBillListRowOptionalProperty[]
): ReadonlyArray<PageVendorBillListRowOptionalProperty> {
    return properties;
}

export function instanceOfPageVendorBillListRow(value: object): value is PageVendorBillListRow {
