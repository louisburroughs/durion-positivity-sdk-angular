 ...
 */
import { ServiceLaborStandardImportRequestDto } from './serviceLaborStandardImportRequestDto';
...
function isOptionalBulkIngestRequestServiceLaborStandardImportRequestDtoPropertyOfType(
...
type BulkIngestRequestServiceLaborStandardImportRequestDtoOptionalProperty = Readonly<{
    name: string;
    nullable: boolean;
}>;

function createBulkIngestRequestServiceLaborStandardImportRequestDtoPropertyNames(...propertyNames: string[]): ReadonlyArray<string> {
    return propertyNames;
}

function createBulkIngestRequestServiceLaborStandardImportRequestDtoOptionalProperties(
    ...properties: BulkIngestRequestServiceLaborStandardImportRequestDtoOptionalProperty[]
): ReadonlyArray<BulkIngestRequestServiceLaborStandardImportRequestDtoOptionalProperty> {
    return properties;
}

export function instanceOfBulkIngestRequestServiceLaborStandardImportRequestDto(value: object): value is BulkIngestRequestServiceLaborStandardImportRequestDto {
