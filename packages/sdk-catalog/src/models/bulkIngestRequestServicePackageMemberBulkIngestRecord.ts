 ...
 */
import { ServicePackageMemberBulkIngestRecord } from './servicePackageMemberBulkIngestRecord';
...
function isOptionalBulkIngestRequestServicePackageMemberBulkIngestRecordPropertyOfType(
...
type BulkIngestRequestServicePackageMemberBulkIngestRecordOptionalProperty = Readonly<{
    name: string;
    nullable: boolean;
}>;

function createBulkIngestRequestServicePackageMemberBulkIngestRecordPropertyNames(...propertyNames: string[]): ReadonlyArray<string> {
    return propertyNames;
}

function createBulkIngestRequestServicePackageMemberBulkIngestRecordOptionalProperties(
    ...properties: BulkIngestRequestServicePackageMemberBulkIngestRecordOptionalProperty[]
): ReadonlyArray<BulkIngestRequestServicePackageMemberBulkIngestRecordOptionalProperty> {
    return properties;
}

export function instanceOfBulkIngestRequestServicePackageMemberBulkIngestRecord(value: object): value is BulkIngestRequestServicePackageMemberBulkIngestRecord {
