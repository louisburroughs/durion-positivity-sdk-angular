 ...
 */
import { ServicePackageBulkIngestRecord } from './servicePackageBulkIngestRecord';
...
function isOptionalBulkIngestRequestServicePackageBulkIngestRecordPropertyOfType(
...
type BulkIngestRequestServicePackageBulkIngestRecordOptionalProperty = Readonly<{
    name: string;
    nullable: boolean;
}>;

function createBulkIngestRequestServicePackageBulkIngestRecordPropertyNames(...propertyNames: string[]): ReadonlyArray<string> {
    return propertyNames;
}

function createBulkIngestRequestServicePackageBulkIngestRecordOptionalProperties(
    ...properties: BulkIngestRequestServicePackageBulkIngestRecordOptionalProperty[]
): ReadonlyArray<BulkIngestRequestServicePackageBulkIngestRecordOptionalProperty> {
    return properties;
}

export function instanceOfBulkIngestRequestServicePackageBulkIngestRecord(value: object): value is BulkIngestRequestServicePackageBulkIngestRecord {
