...
export class ColumnMappingAPIService extends BaseService {
     ...
     */
    public approveColumnMappings(jobId: string, columnMappingApproveRequest: ColumnMappingApproveRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ColumnMappingResponse>>;
    public approveColumnMappings(jobId: string, columnMappingApproveRequest: ColumnMappingApproveRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ColumnMappingResponse>>>;
    public approveColumnMappings(jobId: string, columnMappingApproveRequest: ColumnMappingApproveRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ColumnMappingResponse>>>;
    public approveColumnMappings(jobId: string, columnMappingApproveRequest: ColumnMappingApproveRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
     ...
     * @param options additional options
     */
    public getColumnMappings(jobId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ColumnMappingResponse>>;
    public getColumnMappings(jobId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ColumnMappingResponse>>>;
    public getColumnMappings(jobId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ColumnMappingResponse>>>;
    public getColumnMappings(jobId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (jobId === null || jobId === undefined) {
