...
export interface UpdateEmployeeRequest {
    ...
    hireDate: string;
    /**
     * Id of the employee\'s job role, from the tenant\'s job-role list; omit to clear it
     */
    jobRoleId?: string;
    /**
...
export function instanceOfUpdateEmployeeRequest(value: object): value is UpdateEmployeeRequest {
    ...
    const requiredProperties = createUpdateEmployeeRequestPropertyNames('employeeNumber', 'firstName', 'hireDate', 'lastName', 'status', );
