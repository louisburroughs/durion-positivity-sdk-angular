...
export class TimeEntryApprovalAPIService extends BaseService {
     ...
     * @param locationId Keep only entries clocked at this location; it must lie within the caller\&#39;s location reach (403 LOCATION_SCOPE_DENIED otherwise). When omitted, a caller whose view permission is location-scoped sees only entries within their reach; an unscoped caller sees every location
