...
export function instanceOfListPurchaseOrdersRequest(value: object): value is ListPurchaseOrdersRequest {
    ...
    const optionalStringProperties = createListPurchaseOrdersRequestOptionalProperties({ name: 'currency', nullable: false }, { name: 'locationId', nullable: false }, { name: 'status', nullable: false }, { name: 'vendorId', nullable: false }, );
