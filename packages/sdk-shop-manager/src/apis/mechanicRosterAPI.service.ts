...
// @ts-ignore
import { PagedModelMechanicRosterEntryResponse } from '../models/pagedModelMechanicRosterEntryResponse';
...
export class MechanicRosterAPIService extends BaseService {
    ...
    public listMechanics(status?: 'ACTIVE' | 'INACTIVE' | 'ON_LEAVE', skillCode?: string, page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/shop-manager/mechanics`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<PagedModelMechanicRosterEntryResponse>('get', `${basePath}${localVarPath}`,
            {
