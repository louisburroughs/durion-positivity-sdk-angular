 ...
 */
import { CommercialBulkIngestRecord } from './commercialBulkIngestRecord';
...
function isOptionalBulkIngestRequestCommercialBulkIngestRecordPropertyOfType(
...
type BulkIngestRequestCommercialBulkIngestRecordOptionalProperty = Readonly<{
    name: string;
    nullable: boolean;
}>;

function createBulkIngestRequestCommercialBulkIngestRecordPropertyNames(...propertyNames: string[]): ReadonlyArray<string> {
    return propertyNames;
}

function createBulkIngestRequestCommercialBulkIngestRecordOptionalProperties(
    ...properties: BulkIngestRequestCommercialBulkIngestRecordOptionalProperty[]
): ReadonlyArray<BulkIngestRequestCommercialBulkIngestRecordOptionalProperty> {
    return properties;
}

export function instanceOfBulkIngestRequestCommercialBulkIngestRecord(value: object): value is BulkIngestRequestCommercialBulkIngestRecord {
