...
export class WorkorderPickedItemsService {
    ...
    public consumePickedItems(workorderId: string, consumePickedItemsRequest: ConsumePickedItemsRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<ConsumePickedItemsResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public getPickedItems(workorderId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<Array<WorkorderPickedItemResponse>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
