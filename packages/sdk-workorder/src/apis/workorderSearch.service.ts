...
export class WorkorderSearchService extends BaseService {
     ...
     * @param status One or more exact status values (optional), repeated (status&#x3D;A&amp;status&#x3D;B) or comma-separated (status&#x3D;A,B). Each must be a real WorkorderStatus value; an unrecognized value returns 400.
