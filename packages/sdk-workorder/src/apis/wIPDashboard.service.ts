...
export class WIPDashboardService {
    ...
    public getWipDetail(workorderId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<WorkorderStatusDetail>('get', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public listWip(locationId: string, pageable: Pageable, multiLocation?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (multiLocation !== undefined && multiLocation !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>multiLocation, 'multiLocation');
        }
        ...
        return this.httpClient.request<PageWorkorderStatusView>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
